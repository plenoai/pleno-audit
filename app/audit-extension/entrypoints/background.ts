...
handleNetworkInspection: (data, sender) => networkSecurityInspector.handleNetworkInspection(data as NetworkInspectionRequest, sender),
    ...
    handlePerformanceObserver: (data, sender) => securityEventHandlers.handlePerformanceObserver(data as Record<string, unknown>, sender),
    handlePostMessageExfil: (data, sender) => securityEventHandlers.handlePostMessageExfil(data as Record<string, unknown>, sender),
    handleDOMClobbering: (data, sender) => securityEventHandlers.handleDOMClobbering(data as Record<string, unknown>, sender),
    handleCacheAPIAbuse: (data, sender) => securityEventHandlers.handleCacheAPIAbuse(data as Record<string, unknown>, sender),
    ...
    handleIntersectionObserver: (data, sender) => securityEventHandlers.handleIntersectionObserver(data as Record<string, unknown>, sender),
    handleIndexedDBAbuse: (data, sender) => securityEventHandlers.handleIndexedDBAbuse(data as Record<string, unknown>, sender),
    handleHistoryManipulation: (data, sender) => securityEventHandlers.handleHistoryManipulation(data as Record<string, unknown>, sender),
    handleMessageChannel: (data, sender) => securityEventHandlers.handleMessageChannel(data as Record<string, unknown>, sender),
    handleResizeObserver: (data, sender) => securityEventHandlers.handleResizeObserver(data as Record<string, unknown>, sender),
    ...
    handleEventSourceChannel: (data, sender) => securityEventHandlers.handleEventSourceChannel(data as Record<string, unknown>, sender),
    handleFontFingerprint: (data, sender) => securityEventHandlers.handleFontFingerprint(data as Record<string, unknown>, sender),
    handleIdleCallbackTiming: (data, sender) => securityEventHandlers.handleIdleCallbackTiming(data as Record<string, unknown>, sender),
