import type { PlaybookData, AlertGroup } from '../playbook-types.js';
import { phishingDomainPlaybooks } from './phishing-domain.js';
import { dataExfiltrationPlaybooks } from './data-exfiltration.js';
import { fingerprintingPlaybooks } from './fingerprinting.js';
import { codeInjectionPlaybooks } from './code-injection.js';
import { credentialClipboardPlaybooks } from './credential-clipboard.js';
import { networkCommunicationPlaybooks } from './network-communication.js';
import { monitoringSurveillancePlaybooks } from './monitoring-surveillance.js';
import { aiPolicyPlaybooks } from './ai-policy.js';
import { storageMediaPlaybooks } from './storage-media.js';
